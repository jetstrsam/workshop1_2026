class Formulas:
    ...
    def mruv_posicion(self, posicion_inicial, velocidad_inicial, aceleracion, tiempo):
        ...
        """
        posicion= posicion_inicial + velocidad_inicial*tiempo + (1/2)*aceleracion*tiempo**2
        return posicion
    ...
    def mruv_velocidad(self, velocidad_inicial, aceleracion, tiempo):
        ...
        """
        velocidad_mruv= velocidad_inicial + aceleracion*tiempo
        return velocidad_mruv
    ...
    def energia_cinetica(self, masa, velocidad):
        ...
        """
        ener_cinetica= (1/2)* masa * velocidad**2 
        return ener_cinetica
    ...
    def interes_compuesto(self, capital, tasa, tiempo, n=1):
        ...
        """
        interes_compuesto= capital * (1 + tasa/n)**(n*tiempo)
