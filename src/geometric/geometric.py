...
class Geometria:
    ...
    def es_triangulo_valido(self, lado1, lado2, lado3):
        ...
        """
        validez= (lado1 + lado2 > lado3) and (lado1 + lado3 > lado2) and (lado2 + lado3 > lado1)
        return validez
    ...
    def area_hexagono_regular(self, lado, apotema):
        ...
        """
        area_hexagono= (6 * lado * apotema) / 2
    ...
    def area_superficie_esfera(self, radio):
        ...
        """
        area_superficie_esfera= 4 * math.pi * (radio ** 2)
        return area_superficie_esfera
    ...
    def area_superficie_cilindro(self, radio, altura):
        ...
        """
        area_superficie_cilindro= 2 * math.pi * radio * (radio + altura)
        return area_superficie_cilindro
